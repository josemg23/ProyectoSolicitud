                                ...
                                <tbody>
                                    ...
                                    @if ($solicitud->convenio->tipo_c == 'contrato')
                                        <tr>
                                            ...
                                            <td class="text-left">{{ $solicitud->convenio->contrato->nombre }}
                                            </td>
                                        </tr>
                                    @endif
                                </tbody>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-12" v-else>
                                    ...
                                    <select name="" id="" class="form-control text-capitalize" v-model="rechazo_id">
                                        <option value="" selected disabled>Selecciona un Tipo de Rechazo
                                        </option>
                                ...
                                <div class="form-group col-lg-12" v-if="!contrato && tipo_compra !== 'licitacion'">
                                    <label class="col-form-label">Proveedor</label>
                                    <model-list-select :list="proveedores" v-model="proveedor_id" class="form-control"
                                        :is-disabled="disabled" option-value="id" option-text="proveedor"
                                        placeholder="Elije Un Proveedor">
                                </div>

                            </div>
                            <div class="form-row">
                                <h6 class="text-center font-weight-bold text-danger">Ejecutivo de Compra
                                </h6>
                                {{-- <div class="form-group col-lg-12">
...
<script>
    ...
    const convenio = new Vue({
        ...
        methods: {
            loadProveedor() {
                if (this.solicitud.convenio.tipo_c !== 'contrato') {
                    this.contrato = false;

                    this.proveedor_id = this.solicitud.proveedor_id == null ? '' : this.solicitud.proveedor_id;
                } else {
                    this.contrato = true;
                }
            },
            ...
            getProveedores() {
                let set = this;
                let url = '/evaluacion/proveedores';
                axios.get(url)
                    .then(function(res) {
            ...
            validaciones() {
                if (this.estado == 'aprobado') {
                    ...
                    } else if (this.solicitud.convenio.tipo_c !== 'contrato' && this.proveedor_id === '' && this
                        .tipo_compra !== 'licitacion') {
                        return iziToast.error({
                            title: 'Municipio',
                            message: 'Para esta solicitud debes seleccionar un proveedor',
                            position: 'topRight'
                        });
            ...
            storeAprobacion(data) {
                ...
                let url = '/evaluacion/convenios/' + solicitud.id +
