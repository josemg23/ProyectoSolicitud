...
<script>
    ...
    const insumo = new Vue({
        ...
        methods: {
            loadProveedor() {
                if (this.solicitud.insumo.tipo_in !== 'contrato') {
                    this.contrato = false;
            ...
            validaciones() {
                if (this.estado == 'aprobado') {
                    ...
                    } else if (this.solicitud.insumo.tipo_in !== 'contrato' && this.proveedor_id === '' && this
            ...
            storeAprobacion(data) {
                ...
                let url = '/evaluacion/insumos-y-servicios/' + solicitud.id +
