@section('content')
@section('titulo', '| Aprobacion Contrato Suministros')
<div id="contrato">
    <h1 class="text-danger text-center font-weight-bold">Aprobación - Contrato Suministros</h1>
    <br>
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
        ...
        methods: {
            ...
            validaciones() {
                if (this.estado == 'aprobado') {
                    if (this.isMultiple) {
                        let conteo = this.items.filter(cuenta => cuenta.id === '');
                        if (conteo.length >= 1) {
                            return iziToast.error({
                                title: 'Municipio',
            ...
            storeAprobacion(data) {
                let set = this;
                let url = '/evaluacion/contrato-suministros/' + solicitud.id + '/aprobacion/finanzas';
                axios.post(url, data)
                    .then(function(res) {
