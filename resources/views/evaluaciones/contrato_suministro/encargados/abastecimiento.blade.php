@section('content')
@section('titulo', '| Aprobacion Contrato Suministro')
<div id="contrato">
    <h1 class="text-danger text-center font-weight-bold">Aprobación - Contrato Suministro</h1>
    <br>
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                            ...
                            <div class="table-responsive" style="height: 100%; overflow-y: scroll; ">
                                <table class="table table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach (json_decode($solicitud->contrato->productos) as $producto)
                                            <tr>
    ...
    const contrato = new Vue({
        ...
        methods: {
            ...
            storeAprobacion(data) {
                ...
                let url = '/evaluacion/contrato-suministros/' + solicitud.id +
                    '/aprobacion/abastecimiento';
                axios.post(url, data)
                    .then(function(res) {
                        console.log(res.data)
                        let link = '{{ route('evaluacion.contrato-suministro.index') }}';
