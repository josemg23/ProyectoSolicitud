                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" v-model="estado"
                                                value="aprobado" name="gridRadios" id="gridRadios1" checked
                                                @change="changeEstado">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="gridRadios"
                                                v-model="estado" value="rechazado" id="gridRadios2"
                                                @change="changeEstado">
    ...
    const mantenimiento = new Vue({
        ...
        methods: {
            ...
            storeAprobacion() {
                ...
                let url = '/evaluacion/mantenimientos/' + solicitud.id + '/aprobacion/encargado-mantenimiento';
                axios.post(url, data)
                    .then(function(res) {
