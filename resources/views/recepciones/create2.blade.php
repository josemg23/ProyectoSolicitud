                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-row justify-content-around">
                                ...
                                <div class="form-group col-lg-5" v-if="estado == 'parcial'">
                                ...
                                <div class="form-group col-lg-5"
                                    v-if="estado == 'parcial' && sum_recepcion !== orden.total">
    ...
    <script>
        ...
        const contrato = new Vue({
            ...
            methods: {
                ...
                storeDiferencia() {
                    if (this.diferencia.detalle === '') {
                        return iziToast.error({
                            title: 'Municipio',
                            message: 'No has agregado el detalle',
                            position: 'topRight'
                        });
                ...
                recepcionAprobacion(diferencia, tipo) {
                    Swal.fire({
                        title: "Realizar Recepción!",
                ...
                procesoLicitacion() {
                    if (this.estado == 'completa') {
                        // let monto_orden = Number(this.orden.total.toFixed(2));
                        // let monto_recepcion = Number(this.monto_recepcion.toFixed(2));
                        // if (monto_orden == monto_recepcion) {
                        //     this.licitacion.hasDiferencia = false;
                        // } else if (monto_orden < monto_recepcion || monto_orden > monto_recepcion) {
                        //     this.licitacion.hasDiferencia = true;
                        //     this.licitacion.diferencia = monto_recepcion > monto_orden ? monto_recepcion -
                        //         monto_orden :
                        //         monto_orden - monto_recepcion;
                        //     this.licitacion.tipo = monto_recepcion > monto_orden ? 'egreso' : 'ingreso';
                        // }
                        // if (this.licitacion.diferencia < 1000) {
                        //     this.licitacion.hasAprobacion = false;
                        //     this.licitacion.aprobacion = '';
                        // } else if (this.licitacion.diferencia > 1000 && this.licitacion.diferencia < 1000000) {
                        //     this.licitacion.hasAprobacion = true;
                        //     this.licitacion.aprobacion = 'finanzas';
                        // }
                        if (this.orden.total !== this.monto_recepcion) {
                            ...
                            // if (this.sum_recepcion == this.solicitud.monto_adjudicacion) {
                            //     // this.orden.last_orden = true;
                            // }
