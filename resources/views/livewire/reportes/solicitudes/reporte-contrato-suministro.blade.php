<div>
    <button type="button" class="btn btn-outline-success mb-2" wire:click.prevent="GenerarExcelContrato()">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                                    wire:click.prevent="sortBy('dependencias')" role="button" href="#">
                                    dependencia
                                    @include('includes._sort-icon', ['field' => 'dependencias'])
                                </a></th>
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                        ...
                        @if ($solicitudes->isNotEmpty())
                            @foreach ($solicitudes as $data)
                                <tr>
                                    ...
                                    <td class="p-1 text-center  text-dark">{{ $data->dependencias }}</td>
