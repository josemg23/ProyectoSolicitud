<div>
    <button type="button" class="btn btn-outline-success mb-2" wire:click.prevent="GenerarExcelReporteInsumos()">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                                    wire:click.prevent="sortBy('dependencias.nombre')" role="button" href="#">
                                    Dependencia
                                    @include('includes._sort-icon', ['field' => 'dependencias.nombre'])
                                </a></th>
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                            ...
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                                    wire:click.prevent="sortBy('users.nombres')" role="button" href="#">
                                    Usuario
                            ...
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                                    wire:click.prevent="sortBy('tipo_in')" role="button" href="#">
                                    Tipo Insumos
                                    @include('includes._sort-icon', ['field' => 'tipo_in'])
                                </a></th>
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                        ...
                        @if ($solicitudes->isNotEmpty())
                            @foreach ($solicitudes as $data)
                                <tr>
                                    ...
                                    <td class="p-1 text-center  text-dark">{{ $data->dependencia }}</td>
                                    <td class="p-1 text-center  text-dark">{{ $data->departamento }}</td>
                                    <td class="p-1 text-center  text-dark">{{ $data->total }}</td>
                                    <td class="p-1 text-center  text-dark"> {{ $data->nombre }} </td>
                                    <td class="p-1 text-center  text-dark"> Orden Compra</td>
                                    <td class="p-1 text-center  text-dark"> {{ $data->tipo_in }} </td>
