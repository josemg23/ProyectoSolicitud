<div>
    <button type="button" class="btn btn-outline-success mb-2" wire:click.prevent="GenerarExcelReporteMantenimiento()">
        ...
        <div class="card-body">
            ...
            <div class="row mb-4 justify-content-between">
                <div class="col-lg-4 form-inline ">
                    Proveedor: &nbsp;
                    <select wire:model="select_pro" class="form-control form-control">
                        <option value="">Proveedores</option>
                        @foreach ($proveedorall as $c)
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                                    wire:click.prevent="sortBy('dependencia')" role="button" href="#">
                                    Dependencia
                                    @include('includes._sort-icon', ['field' => 'dependencia'])
                                </a></th>
                            <th class="px-4 py-2 text-center "><a class="text-primary"
