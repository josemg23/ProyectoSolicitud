    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-4 justify-content-between">
                <div class="col-lg-3 form-inline ">
                    Convenios: &nbsp;
                    <select wire:model="select_convenio" class="form-control form-control-sm">
                        <option value="">Convenios</option>
                        @foreach ($conveniosall as $c)
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                                    wire:click.prevent="sortBy('solicitud_convenios.tipo_c')" role="button" href="#">
                                    tipo convenio
                                    @include('includes._sort-icon', ['field' => 'solicitud_convenios.tipo_c'])
                                </a></th>
                            <th class="px-4 py-2 text-center "><a class="text-primary"
                        ...
                        @if ($solicitudes->isNotEmpty())
                            @foreach ($solicitudes as $data)
                                <tr>
                                    ...
                                    <td class="p-1 text-center  text-dark"> {{ $data->tipo_c }} </td>
