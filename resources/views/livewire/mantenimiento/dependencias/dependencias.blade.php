<div>
    ...
    @include('mantenimiento.dependencias.modal.modaldependencia')
    <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#createDependencia"><i
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-1 text-center" width="25">
                                                <a class="btn btn-sm btn-warning text-dark" data-toggle="modal"
                                                    data-target="#createDependencia"
                                                    wire:click.prevent="editDependencia({{ $c->id }})">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                            </td>
                                            <td class="p-1 text-center" width="25">
                                                <a class="btn btn-sm btn-danger text-dark"
                                                    wire:click.prevent="$emit('eliminarRegistro','Seguro que deseas eliminar este Usuario?','eliminarDependencia', {{ $c->id }})">
