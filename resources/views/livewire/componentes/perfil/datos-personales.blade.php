<div>
	...
	<div class="form-row">
		<div class="form-group col-lg-8">
			...
			<input type="text" disabled="" class="form-control text-dark" wire:model.defer="nombres" >
		</div>
		...
		<div class="form-group col-lg-6">
			<label for="" class="col-form-label text-dark font-weight-bold">Fono</label>
			<input type="number" class="form-control text-dark" min="0"  wire:model.defer="fono" >
		</div>
	</div>
