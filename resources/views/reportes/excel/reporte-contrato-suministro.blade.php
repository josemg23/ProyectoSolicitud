<div class="container">
    <h3 style="text-align: center"><strong>REPORTE DE CONTRATO SUMINISTRO</strong></h3>
    <table class="table table-striped">
        <tr>
            <th style="vertical-align: middle; background-color: #D44C4C" scope="col" width="30">TIPO</th>
            <th style="vertical-align: middle; background-color: #D44C4C" scope="col" width="25">DEPENDENCIA</th>
