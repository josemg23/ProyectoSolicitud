...
@section('breadcrumb')
    <li class="___class_+?0___"><a href="{{ route('solicitudes.mis-solicitudes') }}"><i class="fas fa-clipboard"></i>
            Mis
            Solicitudes</a></li>
    <li class="active"><a><i class="fas fa-file-contract"></i> Detalles de Solicitud de Convenio</a>
    </li>
@endsection

@section('titulo', '| Detalle de Solicitud de Convenio')
@section('content')
    <h1 class="text-center font-weight-bold text-danger">Detalle de Solicitud - Convenios</h1>
                            ...
                            @if ($solicitud->convenio->tipo_c == 'contrato')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control" disabled
                                            value="{{ $solicitud->convenio->contrato->nombre }}"></label>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="">Tipo de Contrato</label>
                                        <input type="text" class="form-control" disabled
                                            value="{{ $solicitud->convenio->tipo_contrato->nombre }}">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="">Proveedor</label>
                                        <input type="text" class="form-control" disabled
                                            value="{{ $solicitud->convenio->proveedor->nombre }}">
                                    </div>
