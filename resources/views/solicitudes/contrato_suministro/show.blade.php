...
@section('breadcrumb')
    <li class="___class_+?0___"><a href="{{ route('solicitudes.mis-solicitudes') }}"><i class="fas fa-clipboard"></i>
            Mis
            Solicitudes</a></li>
    <li class="active"><a><i class="fas fa-file-contract"></i> Detalles de Contrato de Suministro</a>
    </li>
@endsection
@section('titulo', '| Contrato de Suministro')

@section('content')
    <h1 class="text-center font-weight-bold text-danger">Detalle de Solicitud - Contrato de Suministros</h1>
